...
\vspace{1cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth]{../_SharedFolder_BourbeauWorkshop/_Graphs/DigitalAgeEffects3}
    \end{center}
\end{frame}
...
\vspace{1cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth]{../_SharedFolder_BourbeauWorkshop/_Graphs/DigitalAgeEffects2}
    \end{center}
\end{frame}
...
\vspace{1cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth]{../_SharedFolder_BourbeauWorkshop/_Graphs/DigitalAgeEffects1}
    \end{center}
\end{frame}
...
\vspace{1cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth]{../_SharedFolder_BourbeauWorkshop/_Graphs/DigitalAgeEffects0}
    \end{center}
\end{frame}
...
=======
    ...
    \begin{frame}
        ...
        \end{itemize}
    \end{frame}
>>>>>>> 775322c8ed5c37193d7a41137ac9df80a76d0388

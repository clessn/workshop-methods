...
\begin{frame}[fragile]{C'est quoi?}
\begin{itemize}
    \item Fondé en 1963 
...
\begin{frame}[fragile]{C'est où?}
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{av8f3d1u.jpg}
    %\caption{Caption}
    \label{fig:my_label}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{campus.jpeg}
    %\caption{Caption}
    \label{fig:my_label}
\end{figure}
\end{frame}
...
\begin{frame}{\Small{Démystifier les idées préconçues}}
\begin{itemize}
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{SciComm-Arthur-Lupia-XL.jpg}
    %\caption{Caption}
    \label{fig:my_label}
\end{figure}
\end{frame}

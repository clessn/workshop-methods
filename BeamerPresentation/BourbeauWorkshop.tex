...
\input{../_BeamerMacros/BeamerMacros.tex} % Loading the macros 
...
%%% BEGINNING OF THE PRESENTATION
    ...
    \begin{frame}
        \frametitle{Objectives \& Philosophy}
        \begin{itemize}
   ...
   \begin{frame}
            ...
            \vspace{0.5cm}
            \begin{center}
              \includegraphics[width=0.4\textwidth]{../_Graphs/RStudio-Logo-Blue-Gradient}
            \end{center} 
            \begin{enumerate}
    ...
    \begin{frame}
            ...
            \vspace{2.3cm}
            \begin{center}
              \includegraphics[width=0.97\textwidth]{../_Graphs/RStudio-Screenshot}
            \end{center} 
    \end{frame}
...
\section{The World \vspace{0.3cm} of Open Source}
    ...
    \begin{frame}
        \frametitle{Why \R?}  \vspace{1.2cm}
        \begin{center}
            \includegraphics[width=0.85\textwidth]{../_Graphs/statPackage-evolution3}
        \end{center} 
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
           \includegraphics[width=0.95\textwidth]{../_Graphs/LaTeX-TableauCodeENG}
        \end{center}  
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
           \includegraphics[width=0.4\textwidth]{../_Graphs/EmoticonConfused.png}
        \end{center}  
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
           \includegraphics[width=0.85\textwidth]{../_Graphs/DesperateImage.png}
        \end{center}  
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
           \includegraphics[width=0.8\textwidth]{../_Graphs/ComplexTableLaTeX}
        \end{center}  
    \end{frame}
...
\end{table} 
    ...
    \begin{frame}
        \frametitle{\LaTeX} \vspace{1cm}   
        \begin{center}
           \includegraphics[width=0.85\textwidth]{../_Graphs/LaTeX-MsWordHug.pdf}
        \end{center}  
    \end{frame}
    ...
    \begin{frame}
        \frametitle{\LaTeX} \vspace{1cm}
        \begin{center}
           \includegraphics[width=0.75\textwidth]{../_Graphs/LaTeX-wordvslatexENG}
        \end{center} 
    \end{frame}
...
Data <- data.frame(vectorString, vectorNumerical, vectorBoolean, c(23,17,32,56))
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=1.1\textwidth]{../_Graphs/DataStructures0.pdf}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{} \vspace{0.7cm}
        \begin{center}
            \includegraphics[width=1.1\textwidth]{../_Graphs/DataStructures1.pdf}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{} \vspace{0.7cm}
        \begin{center}
            \includegraphics[width=1.1\textwidth]{../_Graphs/DataStructures2.pdf}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{} \vspace{0.7cm}
        \begin{center}
            \includegraphics[width=1.1\textwidth]{../_Graphs/DataStructures3.pdf}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=1.1\textwidth]{../_Graphs/DataStructures4.pdf}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=1.1\textwidth]{../_Graphs/DataStructures5.pdf}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=1.1\textwidth]{../_Graphs/DataStructures6.pdf}
        \end{center}
    \end{frame}
...
mean(yourVector)
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.56\textwidth]{../_Graphs/meanGirls.pdf}
        \end{center}
    \end{frame}
...
meanGirlsPlus <- function(Data, star=FALSE){
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=1\textwidth]{../_Graphs/packageEvolution0.pdf}
        \end{center}
    \end{frame} 
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=1\textwidth]{../_Graphs/packageEvolution1.pdf}
        \end{center}
    \end{frame} 
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=1\textwidth]{../_Graphs/packageEvolution2.pdf}
        \end{center}
    \end{frame} 
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=1\textwidth]{../_Graphs/packageEvolution3.pdf}
        \end{center}
    \end{frame} 
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=1\textwidth]{../_Graphs/packageEvolution4.pdf}
        \end{center}
    \end{frame} 
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=1\textwidth]{../_Graphs/MrX0.pdf}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=1\textwidth]{../_Graphs/MrX1.pdf}
        \end{center}
    \end{frame}
...
girlsMeanAge <- meanGirls(MrXOwnData)
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.65\textwidth]{../_Graphs/OpenSource-TS-RPackages2}
        \end{center} 
    \end{frame}

...
=======
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Catégories/\\ Difficulté\end{tabular}} & \begin{tabular}[c]{@{}l@{}}Importation et \\ manipulation des données\end{tabular} & Visualisation de données & \begin{tabular}[c]{@{}l@{}}Probabilités et\\ analyses statistiques\end{tabular} \\ \hline
Débutant & \begin{tabular}[c]{@{}l@{}}Introduction to R;\\ Importing Data in R (part 1);\\ Cleaning Data in R;\\ Introduction to the Tidyverse;\end{tabular} & \begin{tabular}[c]{@{}l@{}}Data visualization in R;\\ Data visualization\\ with ggplot2 (part 1);\end{tabular} & \begin{tabular}[c]{@{}l@{}}Introduction to Data;\\ Exploratory Data Analysis;\\ Foundation of Probability in R;\\ Foundation of Inference;\end{tabular} \\ \hline
Intermédiaire & \begin{tabular}[c]{@{}l@{}}Intermediate R;\\ Intermediate R practice;\\ Introduction to Text\\  Analysis in R;\\ Importing Data in R (part 2);\end{tabular} & \begin{tabular}[c]{@{}l@{}}Data visualization\\ with ggplot2 (part 2);\\ Visualization Best Practices in R;\end{tabular} & \begin{tabular}[c]{@{}l@{}}Correlation and regression;\\ Multiple and Logistic \\ Regression;\\ Exploratory Data Analysis;\end{tabular} \\ \hline
...
>>>>>>> c8d69f805a0cfea6a4a535bc3ba650ca4b3b9c62
\end{tabular}%
}

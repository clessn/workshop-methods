...
%%
    ...
    \begin{frame}
      ...
      Visualiser la distribution de certaines caractéristiques de la littérature
      
        \begin{center}
         \includegraphics[width=1\textwidth]{../_SharedFolder_BourbeauWorkshop/_Graphs/Scoping-Devis.png}
        \end{center} 
...
%%
    ...
    \begin{frame}
      ...
      Visualiser la distribution de certaines caractéristiques de la littérature
        ...
        \begin{center}
         \includegraphics[width=1\textwidth]{../_SharedFolder_BourbeauWorkshop/_Graphs/Scoping-Annee_Thématique.png}
        \end{center} 
...
%%
    ...
    \begin{frame}
     ...
     \begin{center}
         \includegraphics[width=1\textwidth]{../_SharedFolder_BourbeauWorkshop/_Graphs/Scoping-Annee_Distribution.png}
        \end{center} 
...
%%
    ...
    \begin{frame}
      ...
      \frametitle{Scoping review: "D'accord, mais on pourrait faire ça avec Excel"} \vspace{1cm}
...
\label{chelles pour lapprentissage de R}
\end{table}  
